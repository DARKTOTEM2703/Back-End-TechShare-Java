package com.techmate.techmate.repository.specification;
...
public class BorrowSpecification {
    ...
    public static Specification<Borrow> byUser(Integer userId) {
        return (root, query, criteriaBuilder) -> 
            userId == null ? null : criteriaBuilder.equal(root.get("usuario").get("id"), userId);
    }
    ...
    public static Specification<Borrow> byAdmin(Integer adminId) {
        return (root, query, criteriaBuilder) -> 
            adminId == null ? null : criteriaBuilder.equal(root.get("admin").get("id"), adminId);
    }

package com.techmate.techmate.infrastructure.service.User.manager;
...
import com.techmate.techmate.infrastructure.service.User.validator.UserValidator;
...
public class UserManager {
    ...
    public void deleteUser(Integer id) {
        if (!usuarioRepository.existsById(id)) {
            throw new com.techmate.techmate.infrastructure.exception.NotFoundException(

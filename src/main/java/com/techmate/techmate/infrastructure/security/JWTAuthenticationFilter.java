...
import com.techmate.techmate.infrastructure.dto.ApiErrorResponse;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            authCredentials = com.techmate.techmate.infrastructure.config.JacksonConfig.objectMapper().readValue(payload,
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        com.techmate.techmate.infrastructure.config.JacksonConfig.objectMapper().writeValue(response.getWriter(), body);
    }
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        if (!userDetails.isEnabled()) { // FIXED: Usar método directo sin crear entidad Usuario
            ...
            com.techmate.techmate.infrastructure.config.JacksonConfig.objectMapper().writeValue(response.getWriter(), payload);
            return;
        }
        ...
        com.techmate.techmate.infrastructure.config.JacksonConfig.objectMapper().writeValue(response.getWriter(), resp);

package com.techmate.techmate.presentation.api;
...
public class MovementsController {
    ...
    public ResponseEntity<?> createMovement(
            ...
            @RequestParam(value = "comment", required = false) @jakarta.validation.constraints.Size(max = 500, message = "El comentario no puede exceder 500 caracteres") @com.techmate.techmate.infrastructure.validation.SafeString(allowSpecial = true) String comment, // Agregar
                                                                                                                                                                                                                                                            // comentario
                                                                                                                                                                                                                                                            // opcional
